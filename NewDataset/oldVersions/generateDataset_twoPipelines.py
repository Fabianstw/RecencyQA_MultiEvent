...
Task:
Generate EXACTLY 2 stationary temporal questions that relate TWO events or phases.
...
2. Provide ONE short temporal context (ONE sentence):
   - Must describe an EVENT, PHASE or CONDITION where the question becomes relevant.
   - No specific years.
   - No meta reasoning.
...
2. Provide TWO short temporal contexts (ONE sentence each):
   - Each context must describe a different EVENT, PHASE or CONDITION.
   - No specific years.
   - No meta reasoning.
...
if __name__ == "__main__":
    generate_recencyqa_4way(
        "E:\\Uni\\ws2025\\aktuelleThemen\\RecencyQA\\NewDataset\\selected_75.json",
        "recencyqa_OUR_DATASET.json",
        n_single_stationary=2,
        n_multi_stationary=2,
        n_single_nonstat=2,
        n_multi_nonstat=2,

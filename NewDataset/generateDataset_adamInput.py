...
Generate ONE of those questions with events or phases that  relate causally and the other one with events or phases which are ONLY temporal connected
...
Generate ONE of those questions with events that are realated causally and the other one with events that are ONLY temporal connected
Rules:

...
% Wrapped verbatim for prompts
\DefineVerbatimEnvironment{promptblock}{Verbatim}{breaklines=true,breakanywhere=true,fontsize=\small}
...
\author{Peter Schulze \\
  ...
  \texttt{Peter.Schulze@student.uibk.ac.at} \\\And
  Fabian Stiewe \\
  https://github.com/Fabianstw \\
  \texttt{Fabian.Stiewe@student.uibk.ac.at} \\
}
...
\input{sections/appendix_pipeline_json_structure.tex}
